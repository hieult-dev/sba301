...
import { ServiceFilter } from "@/common/components/service-filter"
import { SpaCard } from "@/common/components/spa-card"
import { InteractiveMap } from "@/common/components/interactive-map"
import { Button } from "@/common/components/ui/button"
import { mockSpas, serviceCategories, type Spa } from "@/common/lib/mock-data"
      ...
      <section id="spas" className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-3xl md:text-4xl font-bold">All Spas ({filteredSpas.length})</h2>
          </div>
